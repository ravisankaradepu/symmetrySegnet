...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.DenseImageDataParameter dense_image_data_param = 138;
  inline bool has_dense_image_data_param() const;
  inline void clear_dense_image_data_param();
  static const int kDenseImageDataParamFieldNumber = 138;
  ...
  // optional .caffe.UpsampleParameter upsample_param = 137;
  inline bool has_upsample_param() const;
  inline void clear_upsample_param();
  static const int kUpsampleParamFieldNumber = 137;
